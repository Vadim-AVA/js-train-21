...
class Band {
  ...
  addMember(newMember) {
    if (newMember instanceof Musician) { // Перевірка, чи є newMember екземпляром класу Musician
      this.#members.push(newMember); // Додавання нового музиканта до списку учасників гурту
    } else {
  ...
  playMusic() {
    this.#members.forEach(member => {
      member.play(); // Виклик методу play() для кожного учасника гурту
    });
  }
